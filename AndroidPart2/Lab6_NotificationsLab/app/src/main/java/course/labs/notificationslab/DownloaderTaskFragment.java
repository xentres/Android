...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        Integer[] formattedIds = new Integer[ids.size()];
        int i = 0;

        for (Integer integer : ids) {
            formattedIds[i] = integer;
            i++;
        }
		
		// TODO: Start the DownloaderTask --- DONE ---
        downloaderTask.execute(formattedIds);
    ...
    public class DownloaderTask extends AsyncTask<Integer, Integer, String[]> {
        ...
        // TODO: Uncomment this helper method --- DONE ---
            ...
            mContext.sendOrderedBroadcast(new Intent(
                    ...
                    new BroadcastReceiver() {
                        ...
                        public void onReceive(Context context, Intent intent) {
                            ...
                            // TODO: Check whether or not the MainActivity --- DONE ---
